      ...
      <div id="skills" className="skills-container">
        <div className="skills-space">
          ...
          <div className="skills-space-summary">
            <p>
              A few months ago, I delved into the world of front-end
              development, starting from ground zero. As I rapidly absorb new
              knowledge, my focus has shifted towards the art of web design.
              Today, my main drive is crafting user-friendly website
              experiences, dedicated to building engaging and accessible
          ...
          <div className="skills-icon-container">
            ...
            <div className="bottom-skill skills-icons">
